...
contract Pausable is Ownable {
    ...
    function pauseStatus(bool val) public onlyOwner {
        _paused = val;
        if (val) {
...
contract ERC721Token is ERC721Metadata {
    string private name = "Custom ERC Token";
    string private symbol = "CET";
    string private baseTokenURI = "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/";

    constructor() public ERC721Metadata(name, symbol, baseTokenURI) {}
